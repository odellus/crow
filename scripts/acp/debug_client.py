#!/usr/bin/env python3
"""
Debug client for testing the Crow ACP server.
...
class ACPDebugClient:
    ...
    def start_server(self):
        """Start the Crow ACP server process."""
        print("Starting Crow ACP server...")

        # Activate venv and run crow-acp
        ...
        print(f"✅ Crow ACP server started (PID: {self.process.pid})")
